...
locals {
  aca_agent_pool_id            = module.azdo_agent_pool_data[local.aca_agent_pool_name].pool_id
  ...
  aks_agent_pool_id            = module.azdo_agent_pool_data[local.aks_agent_pool_name].pool_id
